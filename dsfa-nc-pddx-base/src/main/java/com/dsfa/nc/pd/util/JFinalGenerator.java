...
public abstract class JFinalGenerator {
    public static void main(String[] args) {
        ...
        set.add("dsfa_oua_user");
        set.add("dsfa_oua_user_userdept");
        set.add("nc_record_course");
        set.add("sdk_token");
        set.add("nc_autho_info");
        genTables(set);
    }
    ...
    public static void genTables(Set<String> tables) {
        ...
        String baseModelOutputDir = System.getProperty("user.dir") + "/dsfa-nc-pddx-base/src/main/java/" + baseModelPackageName.replace('.', '/');
