...
import com.dsfa.nc.web.pd.domain.courses.Do.CourseInfoSubDO;
import com.dsfa.nc.web.pd.domain.courses.Do.CoursewareDO;
import com.dsfa.nc.web.pd.domain.courses.converter.CoursewareConverter;
...
public class CoursewareRepositoryImpl implements ICoursewareRepository {
    ...
    public List<Courseware> findByCourseID(String coursesInfoId) {
        ...
        List<CourseInfoSubDO> courseInfoSubDOList = courseInfoSubDO.find("select * from nc_course_info_sub");
        ...
        // 搜索课件表
        List<CoursewareDO> coursewareDOList = coursewareDO.find("select * from nc_course_courseware");
