package com.dsfa.nc.web.pd.course.domain.lesson.util;
...
public class JFinalGenerator {
    public static void main(String[] args) {
        ...
        String modelPackageName = "com.dsfa.nc.web.nctest.lsf.demo.courses.dao";
        ...
        MetaBuilder metaBuilder = new MetaBuilder(dataSource)
                ...
                .skip(tableName -> {
                    return !tableName.startsWith("nc_class_student");
                });
        ...
        // 设置去除前缀
        gen.setRemovedTableNamePrefixes("nc_class_");
