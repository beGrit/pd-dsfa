...
public abstract class BaseBjglOutClassFlow<M extends BaseBjglOutClassFlow<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglOutClassFlowId(java.lang.String teasJwglBjglOutClassFlowId) {
		set("teas_jwgl_bjgl_out_class_flow_id", teasJwglBjglOutClassFlowId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglOutClassFlowId() {
		return getStr("teas_jwgl_bjgl_out_class_flow_id");
	}
