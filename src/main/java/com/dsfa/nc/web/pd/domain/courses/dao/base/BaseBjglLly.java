...
public abstract class BaseBjglLly<M extends BaseBjglLly<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglLlyId(java.lang.String teasJwglBjglLlyId) {
		set("teas_jwgl_bjgl_lly_id", teasJwglBjglLlyId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglLlyId() {
		return getStr("teas_jwgl_bjgl_lly_id");
	}
