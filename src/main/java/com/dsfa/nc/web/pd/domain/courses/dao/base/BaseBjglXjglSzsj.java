...
public abstract class BaseBjglXjglSzsj<M extends BaseBjglXjglSzsj<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglXjglSzsjId(java.lang.String teasJwglBjglXjglSzsjId) {
		set("teas_jwgl_bjgl_xjgl_szsj_id", teasJwglBjglXjglSzsjId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglXjglSzsjId() {
		return getStr("teas_jwgl_bjgl_xjgl_szsj_id");
	}
	...
	public java.util.Date getEdate() {
		return getDate("edate");
	}
	
	public M setFfdate(java.util.Date ffdate) {
		set("ffdate", ffdate);
		return (M)this;
	}
	
	public java.util.Date getFfdate() {
		return getDate("ffdate");
	}
