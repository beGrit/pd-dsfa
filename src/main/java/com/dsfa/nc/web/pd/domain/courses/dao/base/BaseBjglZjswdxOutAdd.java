...
public abstract class BaseBjglZjswdxOutAdd<M extends BaseBjglZjswdxOutAdd<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglZjswdxOutAddId(java.lang.String teasJwglBjglZjswdxOutAddId) {
		set("teas_jwgl_bjgl_zjswdx_out_add_id", teasJwglBjglZjswdxOutAddId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglZjswdxOutAddId() {
		return getStr("teas_jwgl_bjgl_zjswdx_out_add_id");
	}
