...
public abstract class BaseBjglTreegl<M extends BaseBjglTreegl<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglTreeglId(java.lang.String teasJwglBjglTreeglId) {
		set("teas_jwgl_bjgl_treegl_id", teasJwglBjglTreeglId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglTreeglId() {
		return getStr("teas_jwgl_bjgl_treegl_id");
	}
