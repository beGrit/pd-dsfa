...
public abstract class BaseBjglBddd<M extends BaseBjglBddd<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglBdddId(java.lang.String teasJwglBjglBdddId) {
		set("teas_jwgl_bjgl_bddd_id", teasJwglBjglBdddId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglBdddId() {
		return getStr("teas_jwgl_bjgl_bddd_id");
	}
