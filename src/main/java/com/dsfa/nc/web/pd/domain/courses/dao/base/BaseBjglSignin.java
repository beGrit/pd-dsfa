...
public abstract class BaseBjglSignin<M extends BaseBjglSignin<M>> extends Model<M> implements IBean {

	public M setTeasJwglBjglSigninId(java.lang.String teasJwglBjglSigninId) {
		set("teas_jwgl_bjgl_signIn_id", teasJwglBjglSigninId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglBjglSigninId() {
		return getStr("teas_jwgl_bjgl_signIn_id");
	}
	...
	public M setTeasJwglPkglPkxxId(java.lang.String teasJwglPkglPkxxId) {
		set("teas_jwgl_pkgl_pkxx_id", teasJwglPkglPkxxId);
		return (M)this;
	}
	
	public java.lang.String getTeasJwglPkglPkxxId() {
		return getStr("teas_jwgl_pkgl_pkxx_id");
	}
	...
	public M setStuText(java.lang.String stuText) {
		set("stu_text", stuText);
		return (M)this;
	}
	
	public java.lang.String getStuText() {
		return getStr("stu_text");
	}
	
	public M setStuValue(java.lang.String stuValue) {
		set("stu_value", stuValue);
		return (M)this;
	}
	
	public java.lang.String getStuValue() {
		return getStr("stu_value");
	}
