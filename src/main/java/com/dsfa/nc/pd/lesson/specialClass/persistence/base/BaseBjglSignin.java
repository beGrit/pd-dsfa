...
public abstract class BaseBjglSignin<M extends BaseBjglSignin<M>> extends Model<M> implements IBean {
	...
	public M setTeasJwglBjglSigninId(String teasJwglBjglSigninId) {
		set("teas_jwgl_bjgl_signIn_id", teasJwglBjglSigninId);
		return (M)this;
	}

	public String getTeasJwglBjglSigninId() {
	...
	public M setTeasJwglPkglPkxxId(String teasJwglPkglPkxxId) {
		set("teas_jwgl_pkgl_pkxx_id", teasJwglPkglPkxxId);
		return (M)this;
	}

	public String getTeasJwglPkglPkxxId() {
	...
	public M setStuText(String stuText) {
	...
	public M setStuValue(String stuValue) {
