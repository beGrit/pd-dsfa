...
public abstract class BaseAccess<M extends BaseAccess<M>> extends DsfaBaseModel<M> {

	public M setCsmlLsfAccessId(String csmlLsfAppraiseId) {
		set("csml_lsf_access_id", csmlLsfAppraiseId);
		return (M)this;
	}
	
	public String getCsmlLsfAccessId() {
		return getStr("csml_lsf_access_id");
	}
