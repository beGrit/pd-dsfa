...
import com.dsfa.nc.pd.lesson.converter.TeacherConverter;
 ...
 **/
@Repository
public class TeacherInfoRepositoryImpl implements ITeacherInfoRepository {
    ...
    public TeacherInfo findById(String teacherId1) {
        ...
        for (TeacherDO teacherDO : teacherDOList) {
            ...
            String enableFlag = teacherDO.getEnabledValue();
            if (StrKit.equals(delTag, "0") && StrKit.equals(enableFlag, "0")) {
    ...
    public TeacherInfo findShowedByCourseId(String courseId) {
        TeacherInfo res = null;
        CourseInfoDO courseInfoDO = TeacherInfoRepositoryImpl.courseInfoDao.findById(courseId);
